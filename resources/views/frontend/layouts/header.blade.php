<header class="header shop">
                    ...
                    <div class="right-content">
                        ...
                        <li><i class="ti-location-pin"></i> <a href="#">Track Order</a></li>
                            ...
                            @auth
                                ...
                                @else
                                    <li><i class="ti-user"></i> <a href="{{route('user')}}"  target="_blank">My Order</a></li>
                                @endif
                    ...
                    <div class="search-bar-top">
                        <div class="search-bar">
                            ...
                            <form method="POST" action="{{route('product.search')}}">
                                ...
                                <button class="btnn bg-info" type="submit" ><i class="ti-search"></i></button>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <!-- Header Inner -->
    <div class="header-inner bg-info">
        <div class="container">
